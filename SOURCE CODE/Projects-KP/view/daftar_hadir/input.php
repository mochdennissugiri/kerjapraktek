                  ...
                  <div class="row">
                    <div class="col-md-4 pl-md-1">
                      <div class="form-group">
                        <label>nama</label>
                        <input type="text" name="karyawan" class="form-control" placeholder="masukan nama">
                      </div>
                    </div>
                    <div class="col-md-4 pl-md-1">
                      <div class="form-group">
                    ...
                    <div class="col-md-4 pl-md-1">
                      <div class="form-group">
                        ...
                        <input type="text" name="kd" class="form-control" placeholder="masukan kehadiran">
                      </div>
                    </div>
                    <div class="col-md-4 pl-md-1">
                      <div class="form-group">
                  ...
                  <div class="col-md-4 pl-md-1">
                    ...
                    <div class="col-md-4 pl-md-1">
                      <div class="form-group">
                        ...
                        <input type="text" name="jamdatang" class="form-control" placeholder="masukan jam datang">
                      </div>
                    </div>
                    <div class="col-md-4 pl-md-1">
                      <div class="form-group">
                        <label>jam pulang</label>
                        <input type="text" name="jampulang" class="form-control" placeholder="masukan jam pulang">
                      </div>
                    </div>
                    <div class="col-md-4 pl-md-1">
                      <div class="form-group">
                        <label>shift</label>
                        <input type="text" name="shift" class="form-control" placeholder="masukan shift">
                      </div>
                    </div>
