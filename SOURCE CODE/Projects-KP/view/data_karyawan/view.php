...
<body class="">
  <div class="wrapper">
    ...
    <div class="main-panel">
            ...
            <div class="card  card-plain">
              ...
              <div class="card-body">
                <div class="table-responsive">
                  <table class="table tablesorter"style="margin-left: 40px; id="">
                    <thead class=" text-primary"><br>
      ...
      echo "<td><a href='edit.php?id_karyawan=$user_datas[id_karyawan]'>edit</a> |<a href='Delete.php?id_karyawan=$user_datas[id_karyawan]'>Delete</a></td></tr>";
    ...
    <div class="dropdown show-dropdown">
      ...
      <ul class="dropdown-menu">
        ...
        <li class="adjustments-line">
          <a href="javascript:void(0)" class="switch-trigger blackground-color">
