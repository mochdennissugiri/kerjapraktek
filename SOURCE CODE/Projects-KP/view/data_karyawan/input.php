                  ...
                  <div class="row">
                    ...
                    <div class="col-md-4 px-md-1">
                      <div class="form-group">
                        ...
                        <input type="text" name="KTP" class="form-control" placeholder="masukan no ktp">
                      </div>
                    </div>
                    <div class="col-md-4 pl-md-1">
                      <div class="form-group">
                        <label>nip</label>
                        <input type="text" name="nip" class="form-control" placeholder="masukan no npwp">
                      </div>
                    </div>
                  </div>
                  <div class="col-md-4 px-md-1">
                      <div class="form-group">
                        ...
                        <input type="text" name="telepon" class="form-control" placeholder="masukan nomor hp">
                      </div>
                    </div>
                    <div class="col-md-4 px-md-1">
                      <div class="form-group">
                    ...
                    <div class="col-md-4 px-md-1">
                      <div class="form-group">
                        <label>kelamin</label>
                        <input type="text" name="kelamin" class="form-control" placeholder="masukan jenis kelamin">
                      </div>
                    </div>
                    <div class="col-md-4 px-md-1">
                      <div class="form-group">
                        <label>tempatlahir</label>
                        <input type="text" name="tempatlahir" class="form-control" placeholder="masukan asal anda">
                      </div>
                    </div>
                    <div class="col-md-4 px-md-1">
                      <div class="form-group">
                        <label>tanggallahir</label>
                        <input type="text" name="tgl" class="form-control" placeholder="masukan tgl lahir">
                      </div>
                    </div>
                    <div class="col-md-4 px-md-1">
                      <div class="form-group">
                        <label>pendidikan_terakhir</label>
                        <input type="text" name="ptrakhir" class="form-control" placeholder="masukan pendidikan terakhir anda">
                      </div>
                    </div>
                    <div class="col-md-4 px-md-1">
                      <div class="form-group">
                        <label>tahun_masuk</label>
                        <input type="text" name="tmasuk" class="form-control" placeholder="masukan tahun masuk anda">
                      </div>
                    </div>
                    <div class="col-md-4 px-md-1">
                      <div class="form-group">
                    ...
                    <div class="col-md-4 px-md-1">
                      <div class="form-group">
                        ...
                        <input type="text" name="janak" class="form-control" placeholder="masukan jumlah anak">
                      </div>
                    </div>
                    <div class="col-md-4 px-md-1">
                      <div class="form-group">
                        <label>bagian</label>
                        <input type="text" name="bagian" class="form-control" placeholder="masukan bagian anda">
                      </div>
                    </div>
                    <div class="col-md-4 px-md-1">
                      <div class="form-group">
                        <label>gaji_karyawan</label>
                        <input type="text" name="gaji" class="form-control" placeholder="masukan gaji anda">
                      </div>
                    </div>
